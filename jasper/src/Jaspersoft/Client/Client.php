...
require_once 'jasper/src/Jaspersoft/Tool/RESTRequest.php';
require_once 'jasper/src/Jaspersoft/Service/ReportService.php';
require_once 'jasper/src/Jaspersoft/Service/RepositoryService.php';

define("BASE_REST2_URL", "/rest_v2");
//define("BASE_REST2_URL", "");
...
class Client
{
	...
	public function reportService()
    {
        if (!isset($this->reportService)) {
            $rs = new service\ReportService($this);
