...
require_once 'jasper/src/Jaspersoft/Exception/RESTRequestException.php';
...
*/
	...
	protected function doExecute (&$curlHandle)
	{
        ...
        //echo "TEST:<br/><pre>" ; print_r($this->response_info); echo "</pre>";
        ...
        //echo "TEST:<br/><pre>" ; print_r($this->response_headers); echo "</pre>";
    ...
    protected function setTimeout(&$curlHandle)
    {
        ...
        curl_setopt($curlHandle, CURLOPT_TIMEOUT, 600); //timeout in seconds
    }
    ...
    public function handleError($statusCode, $expectedCodes, $responseBody)
    {
            if(!empty($responseBody)) {
                ...
                //echo "<pre>"; print_r($expectedCodes); echo "</pre>";
                                   ...
                                   $contentType = 'application/json', $acceptType = 'application/json', $headers = array())
    {
        ...
        if (!in_array($statusCode['http_code'], $expectedCodes)) {
            //$this->handleError($statusCode, $expectedCodes, $responseBody);
            error_log("Jasper Error Generating Report, URL: " . $statusCode['url'] . ", Http Code: " . $statusCode['http_code']);
            return false;
        }
    ...
    public function sendBinary($url, $expectedCodes = array(200), $body = null, $contentType = null, $contentDisposition = null, $contentDescription = null, $verb = "POST")
    {
        $this->flush();
        $this->setUrl($url);
